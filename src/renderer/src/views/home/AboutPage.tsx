      ...
      <div className="border-t border-border-custom pt-6">
        ...
        <div className="space-y-2">
          <a
            ...
            className="flex items-center gap-3 p-3 rounded-xl border border-border-custom bg-surface hover:border-stone-300 hover:bg-stone-50 transition-colors group"
          >
