  ...
  return (
    <div className="space-y-6">
      <div className="text-center py-8">
        ...
        <h1 className="text-2xl font-semibold text-text-primary">Whisper Dictation</h1>
        <p className="text-text-secondary mt-1">Version {version}</p>
      ...
      <div className="border-t border-border-custom pt-6">
        <h3 className="text-sm font-medium uppercase tracking-wide text-text-secondary mb-4">Links</h3>
        <div className="space-y-2">
          <a
            href="https://github.com/bensmith/whisper-dictation"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 p-3 rounded-xl border border-border-custom bg-surface hover:border-border-hover hover:bg-canvas transition-colors group"
          >
          ...
          <div className="flex items-center gap-3 p-3 rounded-xl border border-border-custom bg-surface">
      ...
      <div className="border-t border-border-custom pt-6">
        <h3 className="text-sm font-medium uppercase tracking-wide text-text-secondary mb-4">Credits</h3>
        <div className="text-sm text-text-secondary space-y-2">
          <p>Built with Electron, React, and XState</p>
          <p>Powered by <span className="font-mono text-xs bg-stone-100 px-1.5 py-0.5 rounded">whisper.cpp</span> by Georgi Gerganov</p>
